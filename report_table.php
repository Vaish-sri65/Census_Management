...
<?php
    $attrib=$_GET['attrib'];
    $arr=array();
    $district=["Mandya","mysore","hubli","banglore","madikeri","dharwad","chikmanglur"];
    
    //$result = mysqli_query( $connection, $query );

    foreach($district as $w_id)  {
        
        
        if($attrib=='gender')
        {
            $query2 = "SELECT COUNT(*) totalMale FROM person  inner join house on house.house_id=person.house_id  where sex='m' and district='$w_id';";
          
            $result2 = mysqli_query( $connection, $query2 );
            
            $totalMale = $result2?mysqli_fetch_assoc( $result2 ):0;
            $query2 = "SELECT COUNT(*) totalFemale FROM person inner join house on house.house_id=person.house_id  where sex='f' and district='$w_id';";
        ...
        {
            $query2 = "SELECT COUNT(*) totalHindu FROM person inner join house on house.house_id=person.house_id  where religion='Hindu' and district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
            $totalOrthodox = $result2?mysqli_fetch_assoc( $result2 ):0;
            $query2 = "SELECT COUNT(*) totalChristian FROM person inner join house on house.house_id=person.house_id  where religion='Christian' and district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
            $totalProtestant = $result2?mysqli_fetch_assoc( $result2 ):0;
            $query2 = "SELECT COUNT(*) totalMuslim FROM person inner join house on house.house_id=person.house_id  where religion='Muslim' and district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
        ...
        {
            $query2 = "SELECT COUNT(*) totalIlletrate FROM person inner join house on house.house_id=person.house_id  where education='illitrate' and district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
            $totalIlletrate = $result2?mysqli_fetch_assoc( $result2 ):0;
            $query2 = "SELECT COUNT(*) totalCertificate FROM person inner join house on house.house_id=person.house_id  where education='certificate' and district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
            $totalCertificate = $result2?mysqli_fetch_assoc( $result2 ):0;
            $query2 = "SELECT COUNT(*) totalDegree FROM person inner join house on house.house_id=person.house_id  where education='degree' and district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
            $totalDegree = $result2?mysqli_fetch_assoc( $result2 ):0;
            $query2 = "SELECT COUNT(*) totalMasters FROM person inner join house on house.house_id=person.house_id  where education='masters' and district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
            $totalMasters = $result2?mysqli_fetch_assoc( $result2 ):0;
            $query2 = "SELECT COUNT(*) totalPHD FROM person inner join house on house.house_id=person.house_id  where education='phd' and district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
       ...
       // var_dump($total);
        ...
        {
            $query2 = "SELECT COUNT(*) totalhouse FROM house where district='$w_id';";
        ...
        { 
            ...
            $query2 = "select age from person inner join house on person.house_id=house.house_id where house.district='$w_id';";
            $result2 = mysqli_query( $connection, $query2 );
